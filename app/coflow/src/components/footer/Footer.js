  ...
  return (
    <>
        ...
        <section className='w-full justify-center flex flex-col items-center gap-10 pb-10'>
            ...
            <Link to='/faq' className='hidden lg:flex'>
               <button 
                    type='buttom' 
                    className='text-white py-3 px-8 rounded-md text-lg font-semibold transition-all hover:scale-105'
                    style={{
        ...
        <div className='flex flex-col w-full items-center lg:items-start px-4 3xl:px-0'>
            ...
            >
                <div className='max-w-8xl w-full justify-between flex flex-col xl:flex-row items-center px-4 2xl:p-0 gap-5 xl:gap-0'>
                    ...
                    <div className='flex gap-5 items-center'>
                        ...
                        <button className='bg-transparent border border-white text-white text-lg font-medium py-3 px-6 rounded-lg hover:scale-105 transition-all'>Decline Cookies</button>
                    </div>    
                </div>
            </div>
        </footer>
