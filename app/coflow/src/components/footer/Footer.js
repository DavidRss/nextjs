  ...
  return (
    <>
        <section 
                ...
                style={{
                    background: 'linear-gradient(90deg, hsla(213, 100%, 50%, 0.8) 0%, hsla(213, 100%, 26%, 0.4) 100%)',
                }}
            >
                <div className='max-w-7xl w-full flex py-10 md:py-16 justify-between items-center px-4 3xl:px-0 flex-col md:flex-row gap-5 md:gap-0'>
                    ...
                    <form className='relative flex flex-col items-center md:items-end gap-5 md:block md:gap-0 w-full max-w-680 rounded-full'>
                        <input 
                            className='py-4 pl-10 w-full text-lg xl:text-xl font-semibold bg-white rounded-full' 
                            placeholder='Enter your amount here' 
                            type='email' 
                        />
                        <button 
                            type='buttom' 
                            className='text-white w-full md:w-fit py-3 px-8 text-lg font-semibold md:absolute top-0.5 right-1.5 transition-all hover:scale-105 rounded-full'
                            style={{
                                background: '#0074FF',
        ...
        {children}
        <section className='w-full justify-center flex flex-col items-center gap-10 pb-10 bg-main'>
            <div className='w-full flex items-center gap-5 3xl:gap-0 xl:items-start px-4 3xl:px-0 pt-10 justify-between max-w-8xl flex-col xl:flex-row text-white'>
        ...
        <footer className='w-full text-text flex flex-col items-center bg-thrBg border-t-8'>
        ...
        <div className='flex flex-col gap-8 items-center w-fit px-4 3xl:px-0'>
            <h1 className='text-text text-4xl font-black mb-6 xl:mb-0'>Coflow</h1>
        ...
        <div className='flex flex-col w-full items-center xl:items-start px-4 3xl:px-0'>
            <ul className='flex w-full gap-1  md:gap-8 xl:gap-10 pb-7 flex-col items-center md:items-start md:flex-row sm:pb-0 h-full sm:h-14 max-w-fit md:border-b border-white z-10'>
                <Link to="/about" className='h-8'>
                    <li className={`text-text text-xl hover:text-main nav__item hover:border-b border-main font-semibold transition-all cursor-pointer  h-full sm:text-left`}>About</li>
                </Link>
                <span style={{color: '#595959'}}>•</span>
                <Link to="/about" className='h-8'>
                    <li className={`text-text text-xl hover:text-main nav__item hover:border-b border-main font-semibold transition-all cursor-pointer h-full sm:text-left`}>Merch</li>
                </Link>
                <span style={{color: '#595959'}}>•</span>
                <Link to="/leaderboard" className='h-8'>
                        <li className={`text-text text-xl hover:text-main nav__item hover:border-b border-main font-semibold transition-all cursor-pointer  h-full sm:text-left`}>Leaderboard</li>
                    </Link>
                    <span style={{color: '#595959'}}>•</span>
                    <Link to="/chat" className='h-8' onClick={handleScrollToChat}>
                        <li className={`text-text text-xl hover:text-main nav__item hover:border-b border-main font-semibold transition-all cursor-pointer  h-full sm:text-left`}>Chat</li>
                    </Link>
                    <span style={{color: '#595959'}}>•</span>
                    <Link to="/reward" className='h-8'>
                        <li className={`text-text text-xl hover:text-main nav__item hover:border-b border-main font-semibold transition-all cursor-pointer  h-full sm:text-left`}>Rewards</li>
                    </Link>
            </ul>
            ...
            <div className='flex flex-col w-full gap-8 items-center xl:items-end'>
                <div className='flex items-center justify-center gap-5 px-4 3xl:px-0 w-full'>
                    ...
                    <a href='https://www.tiktok.com/@bricebbrice?is_from_webapp=1&sender_device=pc'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 43 42" fill="none" className='hover:scale-105 p-2 transition-all cursor-pointer hover:shadow-lg hover:shadow-main/50 rounded-full' style={{background: '#3f3f3f'}}>
                            <path d="M29.5498 10.185C28.3535 8.81934 27.6943 7.06551 27.6948 5.25H22.2873V26.95C22.2456 28.1243 21.7498 29.2366 20.9044 30.0526C20.0589 30.8687 18.9298 31.3248 17.7548 31.325C15.2698 31.325 13.2048 29.295 13.2048 26.775C13.2048 23.765 16.1098 21.5075 19.1023 22.435V16.905C13.0648 16.1 7.77979 20.79 7.77979 26.775C7.77979 32.6025 12.6098 36.75 17.7373 36.75C23.2323 36.75 27.6948 32.2875 27.6948 26.775V15.7675C29.8875 17.3422 32.5202 18.1871 35.2198 18.1825V12.775C35.2198 12.775 31.9298 12.9325 29.5498 10.185Z" fill="white"/>
                        </svg>
                    </a>
                    <a href='https://twitter.com/BriceBBrice_'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 60 60" fill="none" className='hover:scale-105 transition-all cursor-pointer hover:shadow-lg hover:shadow-main/50 rounded-full'>
                            <rect width="60" height="60" rx="30" fill="#3F3F3F"/>
                    ...
                    <a href='https://www.instagram.com/bricebrc_/'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 60 60" fill="none" className='hover:scale-105 transition-all cursor-pointer hover:shadow-lg hover:shadow-main/50 rounded-full'>
                            <rect width="60" height="60" rx="30" fill="#3F3F3F"/>
            ...
            <div 
                ...
                style={{
                    background: 'linear-gradient(45deg, #0074FF 0%, #042B58 100%)',
                    boxShadow: ' 0px 4px 0px 0px #042B58',
                }}
            >
