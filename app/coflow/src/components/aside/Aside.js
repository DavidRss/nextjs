...
function Aside() {
    return (
        <aside className='flex flex-col gap-9 w-full xl:w-fit items-center'>
            <h1 className='text-white font-bold text-3xl text-left w-full'>Contreparties</h1>
            <CardsSlider />
            <div className='flex flex-col p-6 font-semibold shadow-lg rounded-lg max-w-sm mb-12 xl:mb-0'>
                <h1 className='text-xl text-white mb-5'>Donne le montant que tu veux Montant à donner</h1>
