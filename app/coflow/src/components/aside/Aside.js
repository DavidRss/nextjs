    ...
    <aside className="flex flex-col gap-9 w-full min-w-425 xl:w-fit items-center">
      ...
      <div className="card bg-mainCard flex flex-col p-6 font-semibold shadow-xl max-w-sm mb-12 xl:mb-0">
        ...
        <input
          ...
          name="price"
          id="price"
          className="block w-full rounded-md bg-input py-4 px-7 text-input placeholder:text-placeholder focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 mb-3 border-0"
          placeholder="Ex : 30"
          value={price}
