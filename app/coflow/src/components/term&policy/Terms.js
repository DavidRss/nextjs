    ...
    return (
        ...
        <dialog id="termes" className="modal">
                <div className="modal-box bg-white text-gray-900 w-full max-w-5xl">
                    <h3 className="font-bold text-lg">Coflow CGV & CGU</h3>
                        <div>
                        <p>Last update: 22/01/2021</p>
                        <h2>Article 1 : Introduction</h2>

<p>Cette boutique en ligne a été mise en place par la société FLOP, société par actions simplifiée, dont le siège social est situé au 4 rue de Gramont, 64100 Bayonne, immatriculée au Registre du Commerce et des Sociétés sous le numéro 980 886 980, représentée par Monsieur Brice Barc, en sa qualité de Gérant, ci-après dénommée « le Vendeur ». Cette boutique en ligne est hébergée par Shopify dont le siège social est situé 150 rue Elgin, Suite 800, Ottawa, Ontario K2P 1L4, Canada.</p>

<p>Toute prise de commande au titre d'un produit figurant au sein de cette boutique en ligne, briceshop.fr suppose la consultation préalable des présentes conditions générales de vente (ci-après dénommées « les CGV »). En conséquence, l’internaute navigant sur le site (ci-après « le Client ») reconnaît être parfaitement informé du fait que son accord concernant le contenu des présentes conditions générales ne nécessite pas la signature manuscrite de ce document, dans la mesure où le Client souhaite commander en ligne les produits présentés dans le cadre de la boutique du site web. La confirmation de la Commande implique l’acceptation par le Client des CGV et des caractéristiques essentielles des produits.</p>
...
<ul>
    <li>notice légale permettant une identification précise du Vendeur</li>
    <li>présentation des caractéristiques essentielles des biens proposés</li>
    <li>indication, en Euros du prix des biens, ainsi que, le cas échéant, des frais de livraison</li>
...
<h2>Article 5 : Entrée en vigueur - Durée</h2>
...
<h2>Article 6 : Signature électronique</h2>
...
<h2>Article 7 : Confirmation de commande</h2>
...
<h2>Article 8 : Preuve de la transaction</h2>
...
<h2>Article 9 : Informations sur les produits</h2>
...
<p>Le paiement de la totalité du prix doit être réalisé lors de la commande. À aucun moment, les sommes versées ne pourront être considérées comme des arrhes ou des acomptes. Le Vendeur se réserve la possibilité de modifier ses prix à tout moment pour l’avenir.</p>

<h2>Article 11 : Mode de paiement</h2>
...
<h2>Article 12 : Clause de réserve de propriété</h2>

<p>Les produits demeurent la propriété du Vendeur jusqu’au complet paiement du prix.</p>
<h2>Article 13 : Disponibilité des produits</h2>
...
<p>La commande sera exécutée au plus tard dans un délai de 30 jours à compter du jour suivant celui où la campagne de vente se termine.</p>
...
<h2>Article 14 : Modalités de livraison</h2>
...
<h2>Article 15 : Problèmes de livraison du fait du transporteur</h2>

<p>Toute anomalie concernant la livraison (avarie, produit manquant par rapport au bon de livraison, colis endommagé, produits cassés...) devra être impérativement indiquée sur le bon de livraison sous forme de "réserves manuscrites", accompagnée de la signature du Client. Le consommateur devra parallèlement confirmer cette anomalie en adressant au transporteur dans les deux (2) jours ouvrables suivants la date de livraison un courrier recommandé avec accusé de réception exposant lesdites réclamations. Le consommateur devra transmettre copie de ce courrier par e-mail à : <a href="mailto:contact@briceshop.fr">contact@briceshop.fr</a></p>

<h2>Article 16 : Erreurs de livraisons</h2>

<p><strong>16-a :</strong> Le consommateur devra formuler auprès du Vendeur le jour même de la livraison ou au plus tard le premier jour ouvré suivant la livraison, toute réclamation d'erreur de livraison et/ou de non-conformité des produits en nature ou en qualité par rapport aux indications figurant sur le bon de commande.</p>

<p><strong>16-b :</strong> La formulation de cette réclamation auprès du Vendeur pourra être faite en envoyant un mail à <a href="mailto:contact@briceshop.fr">contact@briceshop.fr</a>, il sera important de préciser dans le mail la référence de la commande.</p>

<p><strong>16-c :</strong> Toute réclamation non effectuée dans les règles définies ci-dessus et dans les délais impartis ne pourra être prise en compte et dégagera le Vendeur de toute responsabilité vis à vis du consommateur.</p>

<p><strong>16-d :</strong> A réception de la réclamation, le Vendeur attribuera un numéro d'échange du ou des produit(s) concerné(s) et le communiquera par e-mail, par fax ou par téléphone au consommateur. L'échange d'un produit ne peut avoir lieu qu'après l'attribution au consommateur d'un numéro d'échange selon la démarche présentée ci-dessus.</p>

<p>Pour être accepté, tout retour devra être signalé au préalable au Service Client de cette boutique en ligne.</p>

<p>Et ce, à l'adresse suivante : <a href="mailto:contact@briceshop.fr">contact@briceshop.fr</a></p>

<h2>Article 17 : Garantie des produits</h2>
...
<h2>Article 19 : Droits de propriété intellectuelle</h2>
...
<h2>Article 21 : Non validation partielle</h2>
...
<h2>Article 22 : Non renonciation</h2>
...
<h2>Article 24 : Loi applicable</h2>
...
<p>En cas de litige ou de réclamation, le consommateur pourra s’adresser à le Vendeur via le service Client à l'adresse mail suivante: <strong>contact@briceshop.fr</strong> pour obtenir une solution amiable.</p>

<h2>Article 25 : Informatique et libertés</h2>
...
<h2>Article 26 : Clause limitative de responsabilité</h2>
