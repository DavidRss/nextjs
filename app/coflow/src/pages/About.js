...
const Home = () => {
    ...
    const handleRadioChange = (swiper, index, setActiveRadioIndex) => {
        if (swiper) {
    ...
    useEffect(() => {
        const handleSlideChange = (swiper, setActiveRadioIndex) => {
            if (swiper) {
                setActiveRadioIndex(swiper.activeIndex);
            }
        };

        if (swiper1) {
            swiper1.on('slideChange', () => handleSlideChange(swiper1, setActiveRadioIndex1));
        }

        if (swiper2) {
            swiper2.on('slideChange', () => handleSlideChange(swiper2, setActiveRadioIndex2));
        }

        return () => {
            if (swiper1) {
                swiper1.off('slideChange', () => handleSlideChange(swiper1, setActiveRadioIndex1));
            }
            if (swiper2) {
                swiper2.off('slideChange', () => handleSlideChange(swiper2, setActiveRadioIndex2));
            }
        };
    }, [swiper1, swiper2]);

    const handleRadioChange1 = (index) => handleRadioChange(swiper1, index, setActiveRadioIndex1);
    const handleRadioChange2 = (index) => handleRadioChange(swiper2, index, setActiveRadioIndex2);

    return (
        <Main>
            <Header />
            <Navigate />
            <section id='header' className='flex w-full flex-col items-center justify-center'>
                <div className='max-w-7xl w-full flex flex-col xl:flex-row pt-5 md:pt-16 pb-16 items-center xl:items-start gap-14 px-4 3xl:px-0'>
                    <div className='h-full relative rounded-3xl bg-secBg flex items-center justify-center w-full min-h-60' style={{maxWidth: '489px', maxHeight: '590px'}}>
                            ...
                            <div className='block lg:hidden absolute rounded-lg -bottom-5 uppercase px-5 py-4 font-semibold text-black z-50' style={{ background: '#0074FF #4E9D35' }}>
                                platinum pack
                            </div>
                    </div>
                    <div className='flex flex-col gap-5'>
                        <div className='hidden lg:flex badge uppercase px-5 py-4 font-semibold text-white border-0' style={{ background: '#0074FF' }}>
                            platinum pack
                        </div>
                        <h2 className='text-4xl text-center lg:text-left lg:text-6xl font-semibold text-text'>Platinum Pack</h2>
                        <div className='flex flex-col gap-5 max-w-4xl text-text'>
                        ...
                        <div className='flex flex-col md:flex-row md:items-start gap-4 lg:gap-14 text-text'>
                            <div className='flex flex-col gap-5'>
                        ...
                        <div className='flex flex-col sm:flex-row items-center gap-8 pt-8 border-t' style={{borderColor: '#D9D9D9'}}>
                            <div className='flex flex-col gap-3'>
                                <span className='text-4xl text-center sm:text-left font-semibold text-text'>35€</span>
                            ...
                            <button 
                                ...
                                style={{
                                    background: 'linear-gradient(45deg, #0074FF 0%, #0074FF 100%)',
                                    boxShadow: ' 0px 4px 0px 0px #0074FF',
                                }}
                            >
                                Participate
                            </button>
                ...
                <div className='max-w-7xl w-full flex flex-col xl:flex-row-reverse pt-5 pb-20 items-center xl:items-start gap-14 px-4 3xl:px-0'>
                    <div className='h-full relative rounded-3xl bg-secBg flex items-center justify-center w-full min-h-60' style={{maxWidth: '489px', maxHeight: '590px'}}>
                            ...
                            <div className='block lg:hidden absolute rounded-lg -bottom-5 uppercase px-5 py-4 font-semibold text-black z-50' style={{ background: 'linear-gradient(45deg, #0074FF 0%, #0074FF 100%) #0074FF' }}>
                                platinum pack
                            </div>
                    </div>
                    <div className='flex flex-col gap-5'>
                        <div className='hidden lg:flex badge uppercase px-5 py-4 font-semibold text-white border-0' style={{ background: 'linear-gradient(45deg, #0074FF 0%, #0074FF 100%) #0074FF' }}>
                            platinum pack
                        </div>
                        <h2 className='text-4xl text-center lg:text-left lg:text-6xl font-semibold text-text'>Platinum Pack</h2>
                        <div className='flex flex-col gap-5 max-w-4xl text-text'>
            ...
            <section className='flex w-full justify-center py-10 3xl:py-20 bg-thrBg'>
                <div className='w-full flex flex-col gap-14 px-4 3xl:px-0 max-w-480 lg:max-w-7xl'>
                    <h2 className='text-4xl font-semibold px-4 xl:px-0 text-text'>Another Products:</h2>
                    <Swiper 
                        spaceBetween={40}
                        pagination={{
                            clickable: true,
                        ...
                        {data && data.map((item, index) => (
                            <SwiperSlide key={index}>
                                <div className="card w-full shadow-xl mb-12" style={{background: 'rgba(255, 255, 255, 0.07)'}}>
                                    <figure className='h-full flex items-start rounded-t-[16px] rounded-b-none' style={{background: 'rgba(255, 255, 255, 0.07)'}}><img className='rounded-b-none rounded-t-[16px] h-[256px] w-full' src={item.img} alt="Shoes" /></figure>
                                    <div className="py-4 px-5 xl:card-body border-0 rounded-b-xl flex flex-col justify-between h-full" style={{background: 'rgba(255, 255, 255, 0.07)'}}>
                                        <div className='flex flex-col gap-2'>
                                            <h2 className="card-title font-semibold text-xl text-black">{item.title}</h2>
                                            <ul className='text-left mb-8 ml-4 list-disc text-sm xl:text-base text-black font-normal'>
                                                {item.desc.map((descItem, descIndex) => (
                                                    <li className='desc-item opacity-50 text-black' key={descIndex}>{descItem}</li>
                                                ))}
                                            </ul> 
                                        </div>                               
            ...
            <section className='flex w-full bg-main justify-center'>
                <div className='max-w-7xl w-full flex py-5 3xl:py-10 items-center px-4 3xl:px-0 flex-col md:flex-row gap-5 md:gap-0'>
                    ...
                    <div className='flex flex-col items-center w-full px-16'>
                        ...
                        <progress className="progress progress-info h-4" value="40" max="100"></progress>
                    </div>
                    <button 
                        type='buttom' 
                        className='text-text w-full md:w-fit py-3 px-8 text-lg font-semibold transition-all hover:scale-105 rounded-full'
                        style={{
                            background: 'white',
                            boxShadow: ' 0px 4px 0px 0px #0074FF',
                        }}
        ...
        <Footer>
            ...
            <section className='w-full justify-center flex'>
                <div className='w-full justify-center flex relative flex-col-reverse xl:flex-row max-w-1920' style={{background: 'linear-gradient(180deg, rgba(51,51,51,1) 49%, rgba(255,255,255,0) 49%)'}}>
                    ...
                    <div className='w-full 3xl:w-3/5 flex justify-center xl:justify-end full:pr-44 bg-thrBg'>
                        <div className='flex flex-col text-text justify-start items-center xl:items-start pt-10 py-10 px-4 3xl:px-0 3xl:py-0 3xl:pt-20 max-w-none xl:max-w-md 2xl:max-w-xl gap-16 w-full'>
