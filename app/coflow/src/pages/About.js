    ...
    <Page>
      <section className="flex w-full justify-center">
        <div className="max-w-8xl w-full flex flex-col xl:flex-row md:pt-16 pb-20 items-center xl:items-start gap-14 px-4 3xl:px-0">
          <div
            className="h-full rounded-3xl bg-secBg flex items-center justify-center w-full min-h-60"
          ...
          <div className="flex flex-col gap-5">
            <div
              className="badge uppercase px-5 py-4 font-semibold"
              style={{
                background:
            ...
            <div className="flex flex-col gap-5 max-w-4xl">
              ...
              <ul className="flex flex-col text-2xl gap-1 list-disc pl-5">
                <li>
                  Un grand merci de toute l’équipe! et ton nom dans le générique
                  de la vidéo
                </li>
              ...
              <p className="text-2xl">
                C’est la pièce centrale de cette collection, il est
                imprimé en France et fait à partir de coton 100% biologique !
                Crois moi on a vraiment mis <br /> le paquet sur la qualité
              </p>
            </div>
            <div className="flex flex-col md:flex-row md:items-start gap-14">
              ...
              <div className="flex flex-col gap-5">
                ...
                <div className="flex items-center gap-3">
                  <button className="flex items-center justify-center uppercase w-8 h-8 rounded text-white font-medium bg-main hover:shadow-lg hover:shadow-main/50">
                    XS
                  </button>
                  <button className="flex items-center justify-center uppercase w-8 h-8 rounded text-white font-medium bg-main opacity-30 cursor-none">
                    S
                  </button>
                  <button className="flex items-center justify-center uppercase w-8 h-8 rounded text-white font-medium bg-main hover:shadow-lg hover:shadow-main/50">
                    M
      ...
      <section
        className="flex w-full justify-center py-10 3xl:py-20"
            ...
            <div className="flex flex-col mx-auto h-full justify-between">
              <div className="flex flex-col">
                <div
                  ...
                  style={{ maxWidth: "480px", height: "300px" }}
                >
                ...
                <div className="flex flex-col gap-5 max-w-md mt-10">
                  ...
                  <p className="text-xl">
                    Le pack de contribution sympa mais pas folle non plus, la
                    récompense est à la hauteur:
                  </p>
                  ...
                  <button className="flex items-center gap-1.5">
                    ...
                    >
                      <path
                        d="M5.449 9.19523C4.95871 9.19523 4.56125 9.59925 4.56125 10.0976C4.56125 10.596 4.95871 11 5.449 11H8.11224C8.60253 11 8.99999 10.596 8.99999 10.0976C8.99999 9.59925 8.60253 9.19523 8.11224 9.19523H5.449Z"
                        fill="#fff"
                      />
                      <path
                        d="M4.56125 13.2561C4.56125 12.7577 4.95871 12.3536 5.449 12.3536H12.551C13.0413 12.3536 13.4387 12.7577 13.4387 13.2561C13.4387 13.7544 13.0413 14.1585 12.551 14.1585H5.449C4.95871 14.1585 4.56125 13.7544 4.56125 13.2561Z"
                        fill="#fff"
                      />
                      <path
                        d="M5.449 15.5121C4.95871 15.5121 4.56125 15.9161 4.56125 16.4145C4.56125 16.9129 4.95871 17.3169 5.449 17.3169H10.7755C11.2658 17.3169 11.6632 16.9129 11.6632 16.4145C11.6632 15.9161 11.2658 15.5121 10.7755 15.5121H5.449Z"
                        fill="#fff"
                      />
                      <path
                        fill-rule="evenodd"
                        clip-rule="evenodd"
                        d="M13.7714 0.284323C10.6014 -0.0947742 7.39861 -0.0947743 4.22862 0.284323L3.48656 0.373065C1.82488 0.571784 0.525095 1.92263 0.366466 3.61574L0.32391 4.06995C-0.10797 8.67955 -0.10797 13.3204 0.32391 17.93L0.366466 18.3843C0.525095 20.0774 1.82488 21.4282 3.48656 21.6269L4.22862 21.7157C7.39861 22.0948 10.6014 22.0948 13.7714 21.7157L14.5134 21.6269C16.1751 21.4282 17.4749 20.0774 17.6335 18.3843L17.6761 17.93C18.108 13.3204 18.108 8.67956 17.6761 4.06995L17.6335 3.61574C17.4749 1.92264 16.1751 0.571785 14.5134 0.373065L13.7714 0.284323ZM4.43607 2.07677C7.46824 1.71416 10.5318 1.71416 13.5639 2.07677L14.306 2.16551C15.1368 2.26487 15.7867 2.9403 15.866 3.78685L15.9086 4.24106C16.3298 8.73685 16.3298 13.2632 15.9086 17.7589L15.866 18.2132C15.7867 19.0597 15.1368 19.7351 14.306 19.8345L13.5639 19.9232C10.5318 20.2858 7.46824 20.2858 4.43607 19.9232L3.69401 19.8345C2.86317 19.7351 2.21328 19.0597 2.13396 18.2132L2.09141 17.7589C1.67019 13.2631 1.67019 8.73685 2.09141 4.24106L2.13396 3.78685C2.21328 2.9403 2.86317 2.26487 3.69401 2.16551L4.43607 2.07677Z"
                        fill="#fff"
                      />
                    </svg>
                    <span className="hover:pb-1 hover:border-b hover:border-main transition-all">
                      Découvrir les lots
                    </span>
                  </button>
                </div>
              ...
              <div className="flex flex-col">
                ...
                <div className="flex flex-col gap-5 max-w-md mt-10">
                  ...
                  <ul className="list-disc pl-5">
                    ...
                    <li>
                      L’inscription de ton nom au palmarès de la gloire pour
                      l’éternité (tu seras cité au générique de la vidéo quoi,
                      c’est normal elle n’existerait pas sans toi)
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="flex flex-col mx-auto h-full justify-between">
              <div className="flex flex-col">
                ...
                <div className="flex flex-col gap-5 max-w-md mt-10">
                  ...
                  <p className="text-xl">
                    Bravo mineur fou et merci pour ta participation, grâce à toi
                    la vidéo va être folle! Le pack or contient:
                  </p>
                  <ul className="list-disc pl-5">
                    <li>Le pack cuivre</li>
                    <li>
                      Le sweat Premium, de quoi être élégant et montrer que t’es
                      un vrai, tout en ayant chaud ! Un must,
                      également imprimé en France et fait à partir de coton
                      biologique pour une qualité super premiu
                    </li>
                  </ul>
                </div>
              </div>
      ...
      <section className="py-24 flex justify-center bg-thrBg">
        <div className="max-w-8xl w-full flex flex-col xl:flex-row gap-5 xl:gap-0 py-16 justify-between items-center px-4 3xl:px-0">
          <div className="flex flex-col gap-20">
            ...
            <div className="flex flex-col gap-5">
              <p className="text-2xl max-w-4xl">Salut les potes!</p>
              <p className="text-2xl max-w-4xl">
                Imaginez une vidéo Minecraft IRL avec un scénario incroyable,
                des costumes et des décors qui déchirent et pleins d’accessoires
                pour donner vie à Minecraft dans le vrai monde! C’est un projet
                qui me tient vraiment à coeur et que je travaille avec mes
                équipes depuis longtemps et ça va enfin exister! Mais pour ça
                j’ai besoin de vous: je veux que ça soit une aventure en équipe
                et vous pouvez tous participer en soutenant le projet!
              </p>
              <p className="text-2xl max-w-4xl">
                Tous les bénéfices tirés des produits que vous allez acheter
                font permettre de financer la vidéo (et oui parce que pour faire
                une dinguerie pareille, on a besoin de budget pour les décors,
                les caméras, l’équipe, et peut être même des invités surprise…).
                Bref, en achetant sur mon shop vous soutenez mon rêve! Avec
                votre aide on va créer quelque chose de super cool et inédit
                dans le gaming français et on va enfin passer Minecraft de
              ...
              <p className="text-2xl max-w-4xl">
                ...
                et la passion du gaming se rencontrent dans le monde réel. Un
                grand merci à chacun d'entre vous pour votre incroyable soutien.
                En route vers cette incroyable aventure Minecraft IRL !
              </p>
            </div>
            <button
              type="button"
                ...
                >
                  ...
                  >
                    <g filter="url(#filter0_d_187_6945)">
                      <path
                        d="M25 9C25 7.89543 24.1046 7 23 7C21.8954 7 21 7.89543 21 9V9.39046C17.6144 10.2079 15 13.0735 15 16.8974C15 19.513 16.029 21.3562 17.623 22.6358C19.0235 23.76 20.8105 24.3919 22.2174 24.8895L22.3326 24.9302C23.9171 25.4911 25.0716 25.9182 25.8858 26.561C26.5399 27.0774 27 27.7525 27 29.1026C27 31.2109 25.3292 32.8462 23 32.8462C20.9279 32.8462 19 30.9908 19 28.3846C19 27.28 18.1046 26.3846 17 26.3846C15.8954 26.3846 15 27.28 15 28.3846C15 32.224 17.4734 35.6323 21 36.5833V37C21 38.1046 21.8954 39 23 39C24.1046 39 25 38.1046 25 37V36.6095C28.3856 35.7921 31 32.9265 31 29.1026C31 26.504 29.9601 24.6812 28.3642 23.4214C26.9829 22.3309 25.2222 21.7089 23.8302 21.2171L23.6674 21.1595C22.0909 20.6014 20.9379 20.1674 20.127 19.5164C19.471 18.9899 19 18.2904 19 16.8974C19 14.7891 20.6708 13.1538 23 13.1538C25.0721 13.1538 27 15.0092 27 17.6154C27 18.72 27.8954 19.6154 29 19.6154C30.1046 19.6154 31 18.72 31 17.6154C31 13.776 28.5266 10.3677 25 9.41673V9Z"
                        fill="white"
                      />
                      <path
                        fill-rule="evenodd"
                    ...
                    <defs>
                      ...
                      >
                        ...
                        <feBlend
                          ...
                          result="effect1_dropShadow_187_6945"
                        />
                        <feBlend
                          mode="normal"
                          in="SourceGraphic"
                          in2="effect1_dropShadow_187_6945"
                          result="shape"
                        />
                      </filter>
                    </defs>
                    ...
                    <defs>
                      ...
                      >
                        ...
                        <feBlend
                          mode="normal"
                          in2="BackgroundImageFix"
                          result="effect1_dropShadow_187_7081"
                        />
                        <feBlend
                          mode="normal"
                          in="SourceGraphic"
                          in2="effect1_dropShadow_187_7081"
                          result="shape"
                        />
                      </filter>
                    </defs>
      ...
      <section
        className="w-full justify-center flex relative flex-wrap"
        style={{
          background:
          ...
          <div className="flex flex-col justify-start pt-10 py-10 px-4 3xl:px-0 3xl:py-0 3xl:pt-20 max-w-xl gap-16 w-full text-white">
            ...
            >
              ...
              <p>
                ...
                GOTS, et PETA Approved Vegan ce qui garantie une production dans
                le respect des travailleurs, de la planète, des animaux, et de
                vous qui allez adorer les porter.
              </p>
            </div>
            <button
              type="button"
      ...
      <section className="w-full justify-center flex">
        <div className="w-full flex items-center gap-5 3xl:gap-0 xl:items-start px-4 3xl:px-0 py-24 justify-between max-w-8xl flex-col xl:flex-row">
          <div className="flex flex-col gap-10 items-center text-center justify-center">
            ...
            <h2 className="text-4xl font-semibold">100% Secure Payment</h2>
            <p className="text-xl max-w-96">
              All our payments are 100% secure, whether they are made by credit
              card, diamonds or gold bars ;)
            </p>
          </div>
          <div className="flex flex-col gap-10 items-center text-center justify-center">
            <svg
            ...
            <h2 className="text-4xl font-semibold">Fast and safe delivery</h2>
            <p className="text-xl max-w-96">
              Delivery available in France and internationally, safe and fast
              (almost as much as a portal, but not quite)
            </p>
            <button
              type="button"
              className="rounded-full text-2xl font-medium px-8 py-4 bg-main transition-all text-white hover:scale-105"
