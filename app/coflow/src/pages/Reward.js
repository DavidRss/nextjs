                  ...
                  <div className="card w-full bg-mainCard border-sec border text-primary-content">
                    <div className="card-body card-bg rounded-xl flex flex-row justify-between items-center px-10">
                      <div className="flex flex-col items-start">
                        ...
                        <span className="mt-3 text-2xl font-extrabold text-white hidden sm:block">
                          {currentUser?.points}
                        </span>
                      ...
                      <div className="flex flex-col">
                        <span className="mt-3 text-2xl font-extrabold text-white block sm:hidden text-right">
                          {currentUser?.points}
                        </span>
                    ...
                    <div className="card-body bg-mainCard rounded-xl flex flex-row justify-between items-center px-10">
                      <div className="flex flex-col items-start">
                        <div className="flex items-center gap-4">
                          ...
                          <span className="text-white text-opacity-50 font-medium text-xl">
                        ...
                        <progress
                          className="progress progress-success md:w-680 mt-3"
                          value={currentUser?.spending}
                          max={progress && progress.nextLevel.spend}
                        ></progress>
                      </div>
                      <button>
                        <img src={arrow} alt="arrow" />
