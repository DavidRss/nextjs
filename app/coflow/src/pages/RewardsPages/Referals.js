                                    ...
                                    <div className='mt-7 w-full flex flex-col items-center'>
                                        <ul className="ref steps steps-vertical flex flex-col gap-8 mb-8">
                                            <li className="flex items-center gap-5">
                                                <span className='w-16 h-16 flex items-center justify-center rounded-full' style={{background: '#464646'}}>
                                                    1
                                                </span>
                                                <button 
                                        ...
                                        <div className='w-full'>
                                            <div className='w-full flex flex-col refBg gap-12 rounded-xl px-12 py-8' style={{background: '#464646'}}>
                                            ...
                                            <div className='flex flex-col sm:flex-row sm:items-center w-full gap-4 mt-6'>
                                                <input 
                                                    ...
                                                    className={`input w-full cursor-pointer ${
                                                        copied ? 'bg-success bg-opacity-20 text-white font-semibold' : 'bg-white'
                                                      }`}                                                      
