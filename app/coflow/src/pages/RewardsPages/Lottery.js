...
function Lottery() {
    ...
    useEffect(() => {
        ...
        const hourCount = Math.floor((timeDifference % (1000 * 60 * 60 * 24)) / (1000 * 60 * 60));
        const minuteCount = Math.floor((timeDifference % (1000 * 60 * 60)) / (1000 * 60));
                    ...
                    <div className='flex flex-col w-full'>
                        ...
                        <div className='flex flex-col bg-secondary border-pagBg rounded-xl pt-8 sm:pb-20 sm:px-6'>
                                ...
                                <div className='flex flex-col items-start justify-start w-full mt-11 gap-2'>
                                    <h1 className='text-gray-900 text-xl font-semibold mt-2'>What is Lorem Ipsum?</h1>
                                    <p className='text-gray-900 opacity-50 text-base font-normal max-w-lg text-left'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry</p>
                                    ...
                                    <div className="grid px-5 sm:px-0 grid-cols-2 sm:grid-cols-3 md:grid-cols-4 justify-items-start sm:justify-items-center xl:justify-items-start gap-6 w-full">
                                        {lotteryCard.map((card, index) => (
                                            ...
                                            <span className='text-gray-900 font-semibold text-base'>{card.date}</span>
                                        </div>
                                        ))}               
                                    </div>
                               </div>                                                           
