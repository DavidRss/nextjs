                    ...
                    <div className='flex flex-col w-full'>
                        ...
                        <div className='flex flex-col bg-secondary border-pagBg rounded-xl pt-8 sm:px-6'>
                                ...
                                <div className='flex flex-col items-start justify-start w-full mt-11 gap-2'>
                                    <h1 className='text-gray-900 font-semibold text-xl mb-2'>We value friendship</h1>
                                    <p className='text-left text-base font-normal text-gray-900 opacity-60'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s</p>
                                        ...
                                        <div className='relative -top-28 z-10 w-full'>
                                            ...
                                            <div className='flex flex-col sm:flex-row sm:items-center w-full gap-4 mt-6'>
                                                <input 
                                                    ...
                                                    className={`input input-bordered border-pagBg w-full cursor-pointer ${
                                                        copied ? 'bg-success bg-opacity-20 text-gray-900 font-semibold' : 'bg-white'
                                                      }`}                                                      
                                            ...
                                            <div className='mt-12 flex w-full flex-col items-center gap-7'>
                                                <div className="grid grid-flow-col gap-4">
                                                    ...
                                                    <span className='hover:cursor-pointer hover:scale-105 transition-all'><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="fill-current text-primary"><path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"></path></svg></span>
                                                </div>
                                                <span className='text-gray-900 font-semibold text-xl'>You have referred 0 friends</span>
                                            </div>   
                                        </div>                                   
                                    </div>
                                </div>
