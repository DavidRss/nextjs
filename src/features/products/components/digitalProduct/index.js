    ...
    return (
        <>
            <div className="flex flex-col w-full gap-8">
                    ...
                    >
                        <div className="flex flex-col w-full gap-6">
                            <div className="flex w-full justify-between">
                                <h2 className="text-primary font-semibold text-xl dark:text-slate-400">
                ...
                <div
                    className={
                        "card rounded-3xl w-full p-6 bg-cardBg dark:bg-base-100 shadow hover:shadow-md transition-shadow ease-in-out flex justify-center items-center"
                    }
                >
                    <button
